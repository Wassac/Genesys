...
const FACES = {
  boost: [
    { s:0,a:0,t:0,f:0 },{ s:0,a:0,t:0,f:0 },
    { s:1,a:0,t:0,f:0 },{ s:1,a:1,t:0,f:0 },
    { s:0,a:2,t:0,f:0 },{ s:0,a:1,t:0,f:0 }
  ],
  setback: [
    { s:0,a:0,t:0,f:0 },{ s:0,a:0,t:0,f:0 },
    { s:0,a:0,t:0,f:1 },{ s:0,a:0,t:0,f:1 },
    { s:0,a:0,t:1,f:0 },{ s:0,a:0,t:1,f:0 }
  ],
  ability: [
    { s:0,a:0,t:0,f:0 },{ s:1,a:0,t:0,f:0 },
    { s:1,a:0,t:0,f:0 },{ s:2,a:0,t:0,f:0 },
    { s:0,a:1,t:0,f:0 },{ s:0,a:1,t:0,f:0 },
    { s:1,a:1,t:0,f:0 },{ s:0,a:2,t:0,f:0 }
  ],
  difficulty: [
    { s:0,a:0,t:0,f:0 },{ s:0,a:0,t:0,f:1 },
    { s:0,a:0,t:0,f:2 },{ s:0,a:0,t:1,f:0 },
    { s:0,a:0,t:1,f:0 },{ s:0,a:0,t:1,f:0 },
    { s:0,a:0,t:2,f:0 },{ s:0,a:0,t:1,f:1 }
  ],
  proficiency: [
    { s:0,a:0,t:0,f:0 },{ s:1,a:0,t:0,f:0 },
    { s:1,a:0,t:0,f:0 },{ s:2,a:0,t:0,f:0 },
    { s:2,a:0,t:0,f:0 },{ s:0,a:1,t:0,f:0 },
    { s:1,a:1,t:0,f:0 },{ s:1,a:1,t:0,f:0 },
    { s:1,a:1,t:0,f:0 },{ s:0,a:2,t:0,f:0 },
    { s:0,a:2,t:0,f:0 },{ s:1,a:0,t:0,f:0, triumph:true }
  ],
  challenge: [
    { s:0,a:0,t:0,f:0 },{ s:0,a:0,t:0,f:1 },
    { s:0,a:0,t:0,f:1 },{ s:0,a:0,t:0,f:2 },
    { s:0,a:0,t:0,f:2 },{ s:0,a:0,t:1,f:0 },
    { s:0,a:0,t:1,f:0 },{ s:0,a:0,t:1,f:1 },
    { s:0,a:0,t:1,f:1 },{ s:0,a:0,t:2,f:0 },
    { s:0,a:0,t:2,f:0 },{ s:0,a:0,t:0,f:1, despair:true }
  ]
};
...
function rollFaces(type, n, r){
  const faces = FACES[type];
  const out = [];
  for (let i=0; i<n; i++) out.push(faces[Math.floor(r()*faces.length)]);
  return out;
}
...
async function redis(cmd, ...args){
  ...
  catch { throw new Error(`Upstash parse error: ${text.slice(0,200)}`); }
}

/* ------------------ Index helpers ------------------ */
async function loadIndex(){
  const ix = await redis("GET", "pc:index");
  return ix.result ? JSON.parse(ix.result) : [];
}
async function saveIndex(items){
  await redis("SET", "pc:index", JSON.stringify(items));
}
async function upsertIndex(id, name){
  const items = await loadIndex();
  const i = items.findIndex(x => x.id === id);
  if (i >= 0) {
    if (name && items[i].name !== name) { items[i].name = name; await saveIndex(items); }
  } else {
...
export default async function handler(req) {
  try {
    ...
    const segs = url.pathname.split("/").filter(Boolean); // e.g. ["api","genesys","save"]
    ...
    // ---------- PING (diagnostics, requires auth) ----------
    ...
    return bad(`server: ${e && e.message ? e.message : "unknown"}`, 500);
  }
}
